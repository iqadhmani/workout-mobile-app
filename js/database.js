    ...
    createTables: function () {
        ...
        function txFunction(tx) {
            ...
            sql = ["INSERT INTO exercise(name,description,typeId,startImage,endImage) VALUES('Cable Rope Crunch','Slowly pull down on the rope. Hold as soon as you reach the bottom, then repeat',1,'img/actions/cable_rope_crunch.jpg','img/actions/cable_rope_crunch2.jpg');",
                ...
                " INSERT INTO exercise(name,description,typeId,startImage,endImage) VALUES('Barbell Shoulder Press','The Barbell Shoulder Press primarily works on the deltoid muscle of the shoulders but also brings the surrounding muscles into play.',7);",
                ...
                " INSERT INTO exercise(name,description,typeId,startImage,endImage) VALUES('Cross Body Crunch','The cross-body crunch exercise is a variation of the crunch that works both the upper and lower portion of the abs.',1);",
                " INSERT INTO exercise(name,description,typeId,startImage,endImage) VALUES('Treadmill Running','Treadmill running, just like regular running, uses the treadmill exercise equipment to burn calories, tone the body, increase stamina and endurance and is one of the most common forms of cardio exercises',11,'img/actions/Cross Body Crunch.jpg','img/actions/Cross Body Crunch1.jpg');"];
