    ...
    createTables: function () {
        ...
        function txFunction(tx) {
            ...
            sql = ["INSERT INTO exercise(name,description,typeId,startImage,endImage) VALUES('Cable Rope Crunch','Slowly pull down on the rope. Hold as soon as you reach the bottom, then repeat',1,'img/actions/cable_rope_crunch.jpg','img/actions/cable_rope_crunch2.jpg');",
                " INSERT INTO exercise(name,description,typeId) VALUES('Barbell Deadlift','The barbell deadlift is a classic bodybuilding exercise meant for putting on mass and building strength overall throughout the entire body.',2);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Dumbbell Alternate Bicep Curl','standing with your feet shoulders width apart. Pick up the barbells using a palm inward grip. Curl each barbell alternating each time. Repeat for the desired amount of reps.',3);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Barbell Bench Press','Bench press is a great exercise for building a powerful chest. The bench press is one of the power exercises, known to be very effective for building body mass. Learning how to do a proper bench press is well worth the effort.',4);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Barbell Behind The Back Wrist Curl','Stand with your feet shoulders width apart. Grasp the barbell in your hands with your palms facing outwards. Lift the barbell up and down using only your hands while keeping your arms straight.',5);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Band Hip Lift',' To begin this exercise; take a band and secure it underneath two dumbbells so that they wont move. Move your body so that your hips are right under the bands and set up for a basic sit up position with your knees up and feet firm on the floor. Keep your hands extended behind your head. Push your shoulders to the floor as you raise your hips and extend the band as high as possible. Hold onto the position for a few seconds and return to the start. Repeat this exercise for as many repetitions as needed.',6);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Barbell Shoulder Press','The Barbell Shoulder Press primarily works on the deltoid muscle of the shoulders but also brings the surrounding muscles into play.',7);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Cable Rope Triceps Pushdown','The rope triceps pushdown exercise uses a rope to target the triceps muscle for better definition and bigger arms.',8);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Barbell Deep Squat','This is a variation of the regular squat in which rather than squatting till your thighs are parallel with the floor, you squat down as low as you possibly can letting your glutes and hamstrings get more into the exercise. Start off by setting up a weighted barbell with the amount of weight that you would like to perform for this exercise. Then position the bar on your shoulder blades with an overhand shoulder width grip just as in a regular squat position. Bend at your knees and slowly lower yourself towards the ground, squatting down as far as possible and squeezing your squads. Hold for a count then return back up to the starting position. Repeat for as many reps and sets as desired.',9);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Seated Calf Raise','The seated calf raise exercise is one of the simplest and most effective calf workouts.',10);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Ab Crunch Machine','Sit down in the machine and select a resistance that is with-in safe limits of your ability. Do a crunch in a slow controlled manner while slowly breathing out.Pause at the bottom of your crunch for 3 seconds.Return to your starting position in a slow controlled movement.',1);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Cross Body Crunch','The cross-body crunch exercise is a variation of the crunch that works both the upper and lower portion of the abs.',1);",
                " INSERT INTO exercise(name,description,typeId) VALUES('Treadmill Running','Treadmill running, just like regular running, uses the treadmill exercise equipment to burn calories, tone the body, increase stamina and endurance and is one of the most common forms of cardio exercises',11);"];
